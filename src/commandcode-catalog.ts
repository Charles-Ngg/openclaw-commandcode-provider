 ...
 *
 * Ported from pi-commandcode-provider (MIT) so the OpenClaw plugin can enrich
 * live `/models` discovery with reasoning/effort/vision/pricing knowledge that
 * the provider API does not expose.
 *
 * Generated from command-code@1.32.2. Do not edit manually.
 */
